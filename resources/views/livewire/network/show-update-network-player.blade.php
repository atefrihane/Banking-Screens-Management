<div>
    <div class="card card-primary">
        ...
        <div class="card-body">
            <form wire:submit.prevent="handleUpdatePlayer">
                <h3 class="">Update a player</h3>
                ...
                <div class="mx-auto mt-4" style="width: 200px;">
                    <div class="row">
                        <a href="{{route('showNetworkPlayers',$this->player->channel->network_id)}}"
                            class="btn btn-danger ml-3">Cancel
                        </a>
