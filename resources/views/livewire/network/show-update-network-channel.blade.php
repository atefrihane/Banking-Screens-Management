<div>
    <div class="card card-primary">
        ...
        <div class="card-body">
            <form wire:submit.prevent="handleUpdateChannel">
                <h3 class="">Update a channel</h3>
                ...
                <div class="mx-auto mt-4" style="width: 200px;">
                    <div class="row">
                        <a href="{{route('showNetworkChannels',$this->channel->network_id)}}" class="btn btn-danger ml-3">Cancel </a>
