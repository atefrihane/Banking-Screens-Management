<div>
    <div class="card card-primary">
        ...
        <div class="card-body">
            <form wire:submit.prevent="handleAddPlanning">
                <h3 class="">Add a planning</h3>
                ...
                <div class="row mt-3">
                    <div class="col-md-12">
                        ...
                        <input type="datetime-local" class="form-control" wire:model="schedule_time" min={new
                            Date().toISOString().split('T')[0]} placeholder="Schedule time.." required>
                    </div>
